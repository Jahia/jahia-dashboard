...
export const registerAdminRoute = () => {
    ...
    registry.add('adminRoute', 'files', {
        ...
        isSelectable: true,
        iframeUrl: `${window.contextJsParameters.contextPath}/cms/adminframe/default/$ui-lang/${window.contextJsParameters.user.path}.files.html`
    });
    registry.add('adminRoute', 'projects', {
        ...
        isSelectable: true,
        iframeUrl: `${window.contextJsParameters.contextPath}/cms/adminframe/default/$ui-lang/${window.contextJsParameters.user.path}.projects.html`
    });
    registry.add('adminRoute', 'pages', {
        ...
        isSelectable: true,
        iframeUrl: `${window.contextJsParameters.contextPath}/cms/adminframe/default/$ui-lang/${window.contextJsParameters.user.path}.pages.html`
    });
    registry.add('adminRoute', 'tasks', {
        ...
        isSelectable: true,
        iframeUrl: `${window.contextJsParameters.contextPath}/cms/adminframe/default/$ui-lang/${window.contextJsParameters.user.path}.tasks.html`
    });
};
